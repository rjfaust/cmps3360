...
<!-- We will primarily use Slack and Canvas for course communication. We will use Slack primarily as a forum for students to ask questions and to facilitate discussion.  Note, Slack is not FERPA compliant, so email instructors directly if the subject is personal/sensitive. A link for an automatic invite to the class slack in on the canvas homepage.  Course announcements will be posted both in Slack and Canvas. All assignments will be posted in Canvas. Finally, students may also email us with private or sensitive matters. -->
...
<!-- 
We will attempt to reply to all emails and slack posts within 24 hours of receiving them (48 on weekends and holidays). If you submit a question less 24 than hours before an assignment is due, you risk not getting an answer before the deadline.
Subsequently, we expect you all to check your email/slack every 24 hours as well. We encourage students to engage in slack discussions and respond to their classmates questions.
We are all available to have drop in office hours and are available by appointment. Please reach out to us directly to setup extra time if you need more support during the semester.
If you have a general question, please check or post on slack! We will check it regularly to answer common questions on coursework. The solution to your question might already be there! -->
...
<!-- We will follow this book closely throughout the semester, with readings from it most weeks. There will be additional readings assigned throughout the semester, however I will make sure they can be accessed for free online or through library resources. -->
...
<!-- Late Policy:  Homework is due by 11:59 pm on their due date, unless otherwise noted. Late assignments will receive a 10% deduction per day after the due date, unless exceptional circumstances occur. This only applies to homework assignments, not the project or design critiques. Late work will not be accepted for the project or design critiques, except in the presence of exceptional circumstances. Students who cannot submit assignments due to exception circumstances are responsible for communicating with instructors to make up any missed work.   -->
